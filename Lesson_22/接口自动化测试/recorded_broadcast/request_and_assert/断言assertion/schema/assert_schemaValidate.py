...
from Lesson_22.接口自动化测试.recorded_broadcast.request_and_assert.断言assertion.schema.schemaValidate import \
    schema_validate_max


@pytest.mark.parametrize('obj', [{"a": 1, "b": "aaa", "c": "", "d": "", "e": ""}], ids=["校验响应数据类型"])  # ids=[]
